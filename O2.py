...
psi4.core.set_output_file(os.path.join("Output", "O2.dat"), False)
...
with open(os.path.join("Output", "O2.txt"), "w") as f:
    f.write("Quantum Chemistry with Psi4 - O2 Properties\n")
...
print("End of O2 property calculations")